...
export const LandingPage: React.FC<LandingPageProps> = ({ onNavigateToAuth }) => {
  ...
  return (
    <div className="min-h-screen w-full bg-paper-50 dark:bg-ink-950 text-ink-950 dark:text-paper-50 transition-colors duration-300 overflow-x-hidden selection:bg-sage-500 selection:text-white">
      ...
      <section className="relative pt-16 pb-20 md:pt-24 md:pb-28 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          ...
          >
            <button
              onClick={() => onNavigateToAuth('LOGIN')}
              className="flex items-center gap-2.5 px-6 py-3.5 rounded-2xl bg-gradient-to-r from-sage-600 to-sage-500 hover:from-sage-500 hover:to-sage-600 text-white font-bold text-sm shadow-xl shadow-sage-600/25 transition-all transform hover:-translate-y-0.5 active:translate-y-0 cursor-pointer"
            >
            ...
            <button
              onClick={() => onNavigateToAuth('SIGNUP')}
              className="px-6 py-3.5 rounded-2xl bg-paper-100 dark:bg-ink-900 hover:bg-paper-200 dark:hover:bg-ink-850 border border-paper-300 dark:border-ink-800 text-ink-950 dark:text-paper-50 font-bold text-sm transition-all cursor-pointer"
            >
              Create Account
            </button>
          </motion.div>
        ...
        {/* -------------------------------------------------- */}
        <div id="architecture" className="scroll-mt-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-14">
          ...
          {/* Fast Persona Demo Pills (Instant 1-Click Role Sandbox moved down) */}
          <motion.div
            initial={{ opacity: 0, y: 15 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-2.5">
              <button
                ...
                className="px-3.5 py-2 rounded-xl text-xs font-semibold bg-paper-100 dark:bg-ink-900 border border-paper-300 dark:border-ink-800 hover:border-sage-500 dark:hover:border-sage-500 shadow-sm transition-all flex items-center gap-1.5 group cursor-pointer"
              >
      ...
      {/* -------------------------------------------------- */}
      <section id="problem" className="scroll-mt-20 py-20 bg-paper-100/50 dark:bg-ink-900/40 border-y border-paper-200/60 dark:border-ink-800/60">
      ...
      {/* -------------------------------------------------- */}
      <section id="personas" className="scroll-mt-20 py-20 bg-paper-100/50 dark:bg-ink-900/40 border-t border-paper-200/60 dark:border-ink-800/60">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
            <span className="text-xs font-bold text-sage-600 dark:text-sage-400 uppercase tracking-widest">
